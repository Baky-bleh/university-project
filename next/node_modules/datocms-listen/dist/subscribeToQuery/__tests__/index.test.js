...
describe("subscribeToQuery", function () {
    ...
    it("notifies events", function () { return __awaiter(void 0, void 0, void 0, function () {
        var fetcher, onEventDefer, event;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fetcher = makeFakeFetch();
                    ...
                    return [4 /*yield*/, onEventDefer.promise];
                case 1:
                    event = _a.sent();
    ...
    it("notifies errors", function () { return __awaiter(void 0, void 0, void 0, function () {
        var fetcher, onErrorDefer, error, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, onErrorDefer.promise];
                case 1:
                    error = _a.sent();
