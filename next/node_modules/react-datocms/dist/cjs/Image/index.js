...
var bogusBaseUrl = 'https://example.com/';
var buildSrcSet = function (src, width, candidateMultipliers) {
    ...
    return candidateMultipliers
        ...
        var url = new URL(src, bogusBaseUrl);
        if (multiplier !== 1) {
        ...
        return "".concat(url.toString().replace(bogusBaseUrl, '/'), " ").concat(finalWidth, "w");
    })
        .filter(Boolean)
        .join(',');
};
exports.Image = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var sizer = layout !== 'fill' ? (react_1["default"].createElement("img", { className: pictureClassName, style: __assign({ display: 'block', width: '100%' }, pictureStyle), src: "data:image/svg+xml;base64,".concat((0, universal_base64_1.encode)(svg)), "aria-hidden": "true", alt: "" })) : null;
