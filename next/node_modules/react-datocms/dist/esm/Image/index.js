...
export var Image = forwardRef(function (_a, ref) {
    ...
    var sizer = layout !== 'fill' ? (React.createElement("img", { className: pictureClassName, style: __assign({ display: 'block', width: '100%' }, pictureStyle), src: "data:image/svg+xml;base64,".concat(encode(svg)), "aria-hidden": "true", alt: "" })) : null;
