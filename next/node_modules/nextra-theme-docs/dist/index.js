...
import { useMounted as useMounted7, useFSRoute as useFSRoute3 } from "nextra/hooks";
  ...
  if (newWindow) {
    return /* @__PURE__ */ jsxs(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          children,
          /* @__PURE__ */ jsx3("span", { className: "nx-sr-only", children: " (opens in a new tab)" })
        ]
      })
    );
  }
...
import { useRef as useRef2, useCallback, useMemo } from "react";
...
var arrowEl = /* @__PURE__ */ jsx8("span", { className: "nx-transition-transform nx-duration-75 group-hover:nx-translate-x-[2px]", children: "\u2192" });
function Card(_a) {
  var _b = _a, {
    children,
    title,
...
import { useRef as useRef3, useEffect } from "react";
...
import { useState as useState3, useCallback as useCallback2, createContext as createContext5, useContext as useContext5, memo } from "react";
...
var Tree = ({ children }) => /* @__PURE__ */ jsx10("div", { className: "nx-mt-6 nx-select-none nx-text-sm nx-text-gray-800 dark:nx-text-gray-300", children: /* @__PURE__ */ jsx10("div", { className: "nx-inline-flex nx-flex-col nx-rounded-lg nx-border nx-px-4 nx-py-2 dark:nx-border-neutral-800", children }) });
function Ident() {
  const indent = useIndent();
  return /* @__PURE__ */ jsx10(Fragment3, { children: [...Array(indent)].map((_, i) => /* @__PURE__ */ jsx10("span", { className: "nx-inline-block nx-w-5" }, i)) });
}
var Folder = memo(
  ({ label, name, open, children, defaultOpen = false, onToggle }) => {
    ...
    return /* @__PURE__ */ jsxs5("li", { className: "nx-flex nx-list-none nx-flex-col", children: [
      /* @__PURE__ */ jsxs5(
        "a",
        {
          onClick: toggle,
          ...
          children: [
            ...
            /* @__PURE__ */ jsx10("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx10(
              "path",
              {
                fill: "none",
                stroke: "currentColor",
            ...
            /* @__PURE__ */ jsx10("span", { className: "nx-ml-1", children: label != null ? label : name })
          ]
        }
      ),
      isFolderOpen && /* @__PURE__ */ jsx10("ul", { children: /* @__PURE__ */ jsx10(ctx.Provider, { value: indent + 1, children }) })
    ] });
  }
);
Folder.displayName = "Folder";
var File = memo(({ label, name, active }) => /* @__PURE__ */ jsx10(
  "li",
  {
    className: cn6(
    ...
    children: /* @__PURE__ */ jsxs5("a", { className: "nx-inline-flex nx-cursor-default nx-items-center nx-py-1", children: [
      /* @__PURE__ */ jsx10(Ident, {}),
      /* @__PURE__ */ jsx10("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx10(
        "path",
        {
...
import { Fragment as Fragment4, useCallback as useCallback3, useState as useState4, useEffect as useEffect2, useRef as useRef4 } from "react";
...
var Input = forwardRef2(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs6("div", { className: "nx-relative nx-flex nx-items-center nx-text-gray-900 contrast-more:nx-text-gray-800 dark:nx-text-gray-300 contrast-more:dark:nx-text-gray-300", children: [
      /* @__PURE__ */ jsx11(
        "input",
        __spreadValues({
          ref: forwardedRef,
...
function Search({
  ...
  const handleActive = useCallback3(
    (e) => {
    ...
    Transition,
    {
      ...
      children: /* @__PURE__ */ jsx12(
        "kbd",
        {
          ...
          children: value && focused ? "ESC" : mounted && (navigator.userAgent.includes("Macintosh") ? /* @__PURE__ */ jsxs7(Fragment5, { children: [
            /* @__PURE__ */ jsx12("span", { className: "nx-text-xs", children: "\u2318" }),
            "K"
          ] }) : "CTRL K")
        }
      )
  ...
  return /* @__PURE__ */ jsxs7("div", { className: cn8("nextra-search nx-relative md:nx-w-64", className), children: [
    renderList && /* @__PURE__ */ jsx12(
      "div",
      {
      ...
      Transition,
      {
        ...
        children: /* @__PURE__ */ jsx12(
          "ul",
          {
            ...
            children: error ? /* @__PURE__ */ jsxs7("span", { className: "nx-flex nx-select-none nx-justify-center nx-gap-2 nx-p-8 nx-text-center nx-text-sm nx-text-red-500", children: [
              /* @__PURE__ */ jsx12(InformationCircleIcon, { className: "nx-h-5 nx-w-5" }),
              renderString(config.search.error)
            ] }) : loading ? /* @__PURE__ */ jsxs7("span", { className: "nx-flex nx-select-none nx-justify-center nx-gap-2 nx-p-8 nx-text-center nx-text-sm nx-text-gray-400", children: [
              /* @__PURE__ */ jsx12(SpinnerIcon, { className: "nx-h-5 nx-w-5 nx-animate-spin" }),
              renderComponent(config.search.loading)
            ] }) : results.length > 0 ? results.map(({ route, prefix, children, id }, i) => /* @__PURE__ */ jsxs7(Fragment4, { children: [
              prefix,
              /* @__PURE__ */ jsx12(
                "li",
                {
...
import { Fragment as Fragment6, memo as memo2 } from "react";
import { Fragment as Fragment7, jsx as jsx13, jsxs as jsxs8 } from "react/jsx-runtime";
var HighlightMatches = memo2(function HighlightMatches2({
  value,
  match
}) {
    ...
    while ((result = regexp.exec(value)) !== null) {
      res.push(
        /* @__PURE__ */ jsxs8(Fragment6, { children: [
          ...
          /* @__PURE__ */ jsx13("span", { className: "nx-text-primary-600", children: splitText.splice(0, regexp.lastIndex - result.index).join("") })
        ] }, id++)
      );
    ...
    for (let i = 0; i < pageResults.length; i++) {
      ...
      for (let j = 0; j < sectionResults.length; j++) {
        ...
        results2.push({
          ...
          _section_rk: j,
          route: url,
          prefix: isFirstItemOfPage && /* @__PURE__ */ jsx14(
            "div",
            {
              className: cn9(
          ...
          children: /* @__PURE__ */ jsxs9(Fragment8, { children: [
            /* @__PURE__ */ jsx14("div", { className: "nx-text-base nx-font-semibold nx-leading-5", children: /* @__PURE__ */ jsx14(HighlightMatches, { match: search2, value: title }) }),
            content && /* @__PURE__ */ jsx14("div", { className: "excerpt nx-mt-1 nx-text-sm nx-leading-[1.35rem] nx-text-gray-600 dark:nx-text-gray-400 contrast-more:dark:nx-text-gray-50", children: /* @__PURE__ */ jsx14(HighlightMatches, { match: search2, value: content }) })
          ] })
        });
...
function Select({
  ...
  return /* @__PURE__ */ jsx15(Listbox, { value: selected, onChange, children: ({ open }) => /* @__PURE__ */ jsxs10(
    Listbox.Button,
    {
      ref: trigger,
      title,
      ...
      children: [
        selected.name,
        /* @__PURE__ */ jsx15(Portal, { children: /* @__PURE__ */ jsx15(
          Transition2,
          {
            ref: container,
            show: open,
            ...
            children: options.map((option) => /* @__PURE__ */ jsxs10(
              Listbox.Option,
              {
                ...
                children: [
                  option.name,
                  option.key === selected.key && /* @__PURE__ */ jsx15("span", { className: "nx-absolute nx-inset-y-0 nx-flex nx-items-center ltr:nx-right-3 rtl:nx-left-3", children: /* @__PURE__ */ jsx15(CheckIcon, {}) })
                ]
              },
              option.key
            ))
  ...
  return /* @__PURE__ */ jsx16(
    Select,
    {
      ...
      selected: {
        ...
        name: /* @__PURE__ */ jsxs11("span", { className: "nx-flex nx-items-center nx-gap-2", children: [
          /* @__PURE__ */ jsx16(GlobeIcon, {}),
          /* @__PURE__ */ jsx16("span", { className: lite ? "nx-hidden" : "", children: selected == null ? void 0 : selected.text })
        ] })
      },
...
function Footer({ menu }) {
  const config = useConfig();
  return /* @__PURE__ */ jsxs12("footer", { className: "nx-bg-gray-100 nx-pb-[env(safe-area-inset-bottom)] dark:nx-bg-neutral-900 print:nx-bg-transparent", children: [
    /* @__PURE__ */ jsxs12(
      "div",
      {
        className: cn11(
...
function Head() {
  ...
  return /* @__PURE__ */ jsxs13(Fragment9, { children: [
    ...
    /* @__PURE__ */ jsxs13(NextHead, { children: [
      config.faviconGlyph ? /* @__PURE__ */ jsx18(
        "link",
        {
          rel: "icon",
      ...
      children: [
        prev && /* @__PURE__ */ jsxs14(
          Anchor,
          {
            ...
            children: [
              /* @__PURE__ */ jsx19(ArrowRightIcon2, { className: cn12(classes2.icon, "ltr:nx-rotate-180") }),
              prev.title
            ]
          }
        ),
        next2 && /* @__PURE__ */ jsxs14(
          Anchor,
          {
            href: next2.route,
            title: next2.title,
            ...
            children: [
              next2.title,
              /* @__PURE__ */ jsx19(ArrowRightIcon2, { className: cn12(classes2.icon, "rtl:nx-rotate-180") })
            ]
          }
        )
      ]
...
function NavbarMenu({
  ...
  return /* @__PURE__ */ jsx20("div", { className: "nx-relative nx-inline-block", children: /* @__PURE__ */ jsxs15(Menu, { children: [
    /* @__PURE__ */ jsx20(
      Menu.Button,
      {
        className: cn13(
        ...
        children: /* @__PURE__ */ jsx20(
          Menu.Items,
          {
            ...
            children: Object.entries(items || {}).map(([key, item]) => {
              var _a;
              return /* @__PURE__ */ jsx20(Menu.Item, { children: /* @__PURE__ */ jsx20(
                Anchor,
                {
...
function Navbar({ flatDirectories, items }) {
  ...
  return /* @__PURE__ */ jsxs15("div", { className: "nextra-nav-container nx-sticky nx-top-0 nx-z-20 nx-w-full nx-bg-transparent print:nx-hidden", children: [
    /* @__PURE__ */ jsx20(
      "div",
      {
        className: cn13(
    ...
    /* @__PURE__ */ jsxs15("nav", { className: "nx-mx-auto nx-flex nx-h-[var(--nextra-navbar-height)] nx-max-w-[90rem] nx-items-center nx-justify-end nx-gap-2 nx-pl-[max(env(safe-area-inset-left),1.5rem)] nx-pr-[max(env(safe-area-inset-right),1.5rem)]", children: [
      config.logoLink ? /* @__PURE__ */ jsx20(
        Anchor,
        {
      ...
      ) : /* @__PURE__ */ jsx20("div", { className: "nx-flex nx-items-center ltr:nx-mr-auto rtl:nx-ml-auto", children: renderComponent(config.logo) }),
      items.map((pageOrMenu) => {
        ...
        return /* @__PURE__ */ jsxs15(
          Anchor,
          {
            ...
            children: [
              /* @__PURE__ */ jsx20("span", { className: "nx-absolute nx-inset-x-0 nx-text-center", children: page.title }),
              /* @__PURE__ */ jsx20("span", { className: "nx-invisible nx-font-medium", children: page.title })
            ]
          },
          href
        );
      ...
      config.project.link ? /* @__PURE__ */ jsx20(
        Anchor,
        {
      ...
      config.chat.link ? /* @__PURE__ */ jsx20(
        Anchor,
        {
          className: "nx-p-2 nx-text-current",
...
var Folder2 = memo3(function FolderInner(props) {
  ...
  return /* @__PURE__ */ jsx23(FolderLevelContext.Provider, { value: level + 1, children: /* @__PURE__ */ jsx23(FolderImpl, __spreadValues({}, props)) });
});
var classes4 = {
  link: cn14(
...
function FolderImpl({ item, anchors }) {
  ...
  return /* @__PURE__ */ jsxs16("li", { className: cn14({ open, active }), children: [
    /* @__PURE__ */ jsxs16(
      ComponentToUse,
      {
    ...
    /* @__PURE__ */ jsx23(Collapse, { className: "ltr:nx-pr-0 rtl:nx-pl-0 nx-pt-1", isOpen: open, children: Array.isArray(item.children) ? /* @__PURE__ */ jsx23(
      Menu2,
      {
  ...
  return /* @__PURE__ */ jsx23(
    "li",
    {
      ...
      children: title ? renderComponent(config.sidebar.titleComponent, {
        ...
        type: "separator",
        route: ""
      }) : /* @__PURE__ */ jsx23("hr", { className: "nx-mx-2 nx-border-t nx-border-gray-200 dark:nx-border-primary-100/10" })
    }
  );
}
function File2({
  ...
  return /* @__PURE__ */ jsxs16("li", { className: cn14(classes4.list, { active }), children: [
    /* @__PURE__ */ jsx23(
      Anchor,
      {
    ...
    active && anchors.length > 0 && /* @__PURE__ */ jsx23(
      "ul",
      {
        className: cn14(
          classes4.list,
        ...
        children: anchors.map(({ id, value }) => {
          var _a;
          return /* @__PURE__ */ jsx23("li", { children: /* @__PURE__ */ jsx23(
            "a",
            {
              href: `#${id}`,
              className: cn14(
...
function Menu2({
  ...
  return /* @__PURE__ */ jsx23("ul", { className: cn14(classes4.list, className), children: directories.map(
    (item) => !onlyCurrentDocs || item.isUnderCurrentDocsTree ? item.type === "menu" || item.children && (item.children.length || !item.withIndexPage) ? /* @__PURE__ */ jsx23(Folder2, { item, anchors }, item.name) : /* @__PURE__ */ jsx23(File2, { item, anchors }, item.name) : null
  ) });
}
function Sidebar({
  docsDirectories,
  ...
  return /* @__PURE__ */ jsxs16(Fragment10, { children: [
    includePlaceholder && asPopover ? /* @__PURE__ */ jsx23("div", { className: "max-xl:nx-hidden nx-h-0 nx-w-64 nx-shrink-0" }) : null,
    /* @__PURE__ */ jsx23(
      "div",
      {
        className: cn14(
    ...
    /* @__PURE__ */ jsxs16(
      "aside",
      {
        ...
        ref: containerRef,
        children: [
          /* @__PURE__ */ jsx23("div", { className: "nx-px-4 nx-pt-4 md:nx-hidden", children: renderComponent(config.search.component, {
            directories: flatDirectories
          }) }),
          /* @__PURE__ */ jsx23(FocusedItemContext.Provider, { value: focused, children: /* @__PURE__ */ jsx23(
            OnFocuseItemContext.Provider,
            {
              ...
              children: /* @__PURE__ */ jsxs16(
                "div",
                {
                  ...
                  ref: sidebarRef,
                  children: [
                    (!asPopover || !showSidebar) && /* @__PURE__ */ jsx23(Collapse, { isOpen: showSidebar, horizontal: true, children: /* @__PURE__ */ jsx23(
                      Menu2,
                      {
          ...
          hasMenu && /* @__PURE__ */ jsxs16(
            "div",
            {
              ...
              children: [
                ...
                config.darkMode && /* @__PURE__ */ jsx23(
                  "div",
                  {
                ...
                config.sidebar.toggleButton && /* @__PURE__ */ jsx23(
                  "button",
                  {
...
var SkipNavContent = forwardRef3(
  function(_a, forwardedRef) {
    ...
    return /* @__PURE__ */ jsx24("div", __spreadProps(__spreadValues({}, props), { ref: forwardedRef, id: id || DEFAULT_ID }));
  }
);
...
function ThemeSwitch({
  ...
  return /* @__PURE__ */ jsx27(
    Select,
    {
      ...
      selected: {
        key: theme2,
        name: /* @__PURE__ */ jsxs18("div", { className: "nx-flex nx-items-center nx-gap-2 nx-capitalize", children: [
          /* @__PURE__ */ jsx27(IconToUse, {}),
          /* @__PURE__ */ jsx27("span", { className: lite ? "md:nx-hidden" : "", children: mounted ? options[theme2] : options.light })
        ] })
      }
    }
  );
...
import { useEffect as useEffect4, useRef as useRef6, useMemo as useMemo3 } from "react";
...
function TOC({ headings, filePath }) {
  ...
  return /* @__PURE__ */ jsxs19(
    "div",
    {
      ...
      children: [
        hasHeadings && /* @__PURE__ */ jsxs19(Fragment11, { children: [
          /* @__PURE__ */ jsx28("p", { className: "nx-mb-4 nx-font-semibold nx-tracking-tight", children: renderComponent(config.toc.title) }),
          /* @__PURE__ */ jsx28("ul", { children: items.map(({ id, value, depth }) => {
            var _a2, _b, _c, _d;
            return /* @__PURE__ */ jsx28("li", { className: "nx-my-2 nx-scroll-my-6 nx-scroll-py-6", children: /* @__PURE__ */ jsx28(
              "a",
              {
                href: `#${id}`,
                className: cn18(
        ...
        hasMetaInfo && /* @__PURE__ */ jsxs19(
          "div",
          {
            ...
            children: [
              config.feedback.content ? /* @__PURE__ */ jsx28(
                Anchor,
                {
...
var DEFAULT_THEME = {
  ...
  chat: {
    icon: /* @__PURE__ */ jsxs20(Fragment12, { children: [
  ...
  gitTimestamp: function GitTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ jsxs20(Fragment12, { children: [
      "Last updated on",
      " ",
      /* @__PURE__ */ jsx30("time", { dateTime: timestamp.toISOString(), children: timestamp.toLocaleDateString(locale, {
        day: "numeric",
        month: "long",
        year: "numeric"
      }) })
  ...
  head: /* @__PURE__ */ jsxs20(Fragment12, { children: [
    /* @__PURE__ */ jsx30("meta", { name: "msapplication-TileColor", content: "#fff" }),
    /* @__PURE__ */ jsx30("meta", { httpEquiv: "Content-Language", content: "en" }),
    /* @__PURE__ */ jsx30("meta", { name: "description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx30("meta", { name: "twitter:card", content: "summary_large_image" }),
    /* @__PURE__ */ jsx30("meta", { name: "twitter:site", content: "@shuding_" }),
    /* @__PURE__ */ jsx30("meta", { property: "og:title", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx30("meta", { property: "og:description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx30("meta", { name: "apple-mobile-web-app-title", content: "Nextra" })
  ] }),
  i18n: [],
  logo: /* @__PURE__ */ jsxs20(Fragment12, { children: [
    /* @__PURE__ */ jsx30("span", { className: "nx-font-extrabold", children: "Nextra" }),
    /* @__PURE__ */ jsx30("span", { className: "nx-ml-2 nx-hidden nx-font-normal nx-text-gray-600 md:nx-inline", children: "The Next Docs Builder" })
  ] }),
  logoLink: true,
  navbar: {
    component: Navbar
  ...
  search: {
    component: function Search2({ className, directories }) {
      const config = useConfig();
      return config.flexsearch ? /* @__PURE__ */ jsx30(Flexsearch, { className }) : /* @__PURE__ */ jsx30(MatchSorterSearch, { className, directories });
    },
    emptyResult: /* @__PURE__ */ jsx30("span", { className: "nx-block nx-select-none nx-p-8 nx-text-center nx-text-sm nx-text-gray-400", children: "No results found." }),
...
import { useEffect as useEffect5, useRef as useRef7, useState as useState8, cloneElement, Children } from "react";
...
var A = (_a) => {
  ...
  return /* @__PURE__ */ jsx31(Anchor, __spreadValues({ href, newWindow: EXTERNAL_HREF_REGEX.test(href) }, props));
};
var getComponents = ({
  isRawLayout,
  components
  ...
  return __spreadValues({
    h1: (props) => /* @__PURE__ */ jsx31(
      "h1",
      __spreadValues({
        className: "nx-mt-2 nx-text-4xl nx-font-bold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100"
      }, props)
    ),
    h2: (props) => /* @__PURE__ */ jsx31(HeadingLink, __spreadValues({ tag: "h2", context }, props)),
    h3: (props) => /* @__PURE__ */ jsx31(HeadingLink, __spreadValues({ tag: "h3", context }, props)),
    h4: (props) => /* @__PURE__ */ jsx31(HeadingLink, __spreadValues({ tag: "h4", context }, props)),
    h5: (props) => /* @__PURE__ */ jsx31(HeadingLink, __spreadValues({ tag: "h5", context }, props)),
    h6: (props) => /* @__PURE__ */ jsx31(HeadingLink, __spreadValues({ tag: "h6", context }, props)),
    ul: (props) => /* @__PURE__ */ jsx31(
      "ul",
      __spreadValues({
        className: "nx-mt-6 nx-list-disc first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
      }, props)
    ),
    ol: (props) => /* @__PURE__ */ jsx31(
      "ol",
      __spreadValues({
    ...
    blockquote: (props) => /* @__PURE__ */ jsx31(
      "blockquote",
      __spreadValues({
        className: cn19(
    ...
    hr: (props) => /* @__PURE__ */ jsx31("hr", __spreadValues({ className: "nx-my-8 dark:nx-border-gray-900" }, props)),
    a: Link,
    table: (props) => /* @__PURE__ */ jsx31(
      Table,
      __spreadValues({
        className: "nextra-scrollbar nx-mt-6 nx-p-0 first:nx-mt-0"
      }, props)
    ),
    p: (props) => /* @__PURE__ */ jsx31("p", __spreadValues({ className: "nx-mt-6 nx-leading-7 first:nx-mt-0" }, props)),
    tr: Tr,
    th: Th,
    td: Td,
    details: Details,
...
var Body = ({
  ...
  const gitTimestampEl = (
    ...
    mounted && date ? /* @__PURE__ */ jsx32("div", { className: "nx-mt-12 nx-mb-8 nx-block nx-text-xs nx-text-gray-500 ltr:nx-text-right rtl:nx-text-left dark:nx-text-gray-400", children: renderComponent(config.gitTimestamp, { timestamp: date }) }) : /* @__PURE__ */ jsx32("div", { className: "nx-mt-16" })
  );
  ...
  return /* @__PURE__ */ jsx32(
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxs22("main", { className: "nx-w-full nx-min-w-0 nx-max-w-6xl nx-px-6 nx-pt-4 md:nx-px-12", children: [
        breadcrumb,
        body
      ] })
    }
...
var InnerLayout = ({
  ...
  const tocEl = activeType === "page" || !themeContext.toc || themeContext.layout !== "default" ? themeContext.layout !== "full" && themeContext.layout !== "raw" && /* @__PURE__ */ jsx32("nav", { className: classes5.toc, "aria-label": "table of contents" }) : /* @__PURE__ */ jsx32(
    "nav",
    {
  ...
  return (
    ...
    // `html` element.
    /* @__PURE__ */ jsxs22("div", { dir: direction, children: [
      /* @__PURE__ */ jsx32(
        "script",
        {
      ...
      /* @__PURE__ */ jsx32(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs22(ActiveAnchorProvider, { children: [
            /* @__PURE__ */ jsx32(
              Sidebar,
              {
                docsDirectories,
            ...
            /* @__PURE__ */ jsx32(
              ...
              {
                themeContext,
                breadcrumb: activeType !== "page" && themeContext.breadcrumb ? /* @__PURE__ */ jsx32(Breadcrumb, { activePath }) : null,
                timestamp,
                navigation: activeType !== "page" && themeContext.pagination ? /* @__PURE__ */ jsx32(
                  NavLinks,
                  {
...
function Layout(_a) {
  ...
  return /* @__PURE__ */ jsx32(ConfigProvider, { value: context, children: /* @__PURE__ */ jsx32(InnerLayout, __spreadProps(__spreadValues({}, context.pageOpts), { children })) });
}
export {
  Bleed,
  Callout,
